...
params <- read.delim("echo_run_params.tsv")
...
for (ord in orders) {
    ...
    for (i in 1:nrow(params)) {
        ...
        file <- paste0(raw_res_path,"echo_run",params$run[i],"_discarded_otus.tsv")
