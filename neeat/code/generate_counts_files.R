...
pcounts <- counts
sample_counts <- colSums(counts[,2:ncol(counts)])
...
write.table(counts,"../bigdata/tot_proportional_cluster_counts.tsv",sep="\t",row.names=FALSE)
...
write.table(counts,"../bigdata/sample_proportional_cluster_counts.tsv",sep="\t",row.names=FALSE)
